...
shinyUI(fluidPage(
  setBackgroundColor(
    color = c("#FFFFFF", "#F0F8FF"),
    gradient = "linear",
    direction = "bottom"
  ),
  # Header:
  
  titlePanel(title=div(img(src="logo1.png",height= "10%", width ="20%",align='Right')),windowTitle= "Grahak.IO"),
